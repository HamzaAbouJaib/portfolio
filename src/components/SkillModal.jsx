...
const SkillModal = ({ setShowSkillsModal }) => {
  return (
    <div
      className="fixed top-0 left-0 z-20 w-full h-full bg-black/80 flex justify-center items-center"
      id="background"
      onClick={(e) => {
        const { target } = e;
    ...
    >
      <div className="w-[80%] md:w-[70%] max-h-[80%] bg-slate-100 dark:bg-neutral-950 rounded-xl p-10 overflow-scroll">
