const LandingPage = () => {
  return (
    <section className="flex justify-center items-center h-screen">
      <div className="max-w-[850px] flex flex-col items-center gap-6 px-10">
        <h1 className="text-4xl sm:text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-cyan-600 to-blue-500">
          Hamza Abou Jaib
        </h1>
        <h3 className="text-3xl sm:text-4xl font-bold">Software Developer</h3>
        <h5 className="text-2xl font-bold text-gray-600 border-b-2 border-b-blue-500 pb-5 px-16">
          McMaster diploma
        </h5>
